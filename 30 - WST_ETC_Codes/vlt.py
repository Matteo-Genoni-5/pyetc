...
class VLT(ETC):
    ...
    def __init__(self, log=logging.INFO, skip_dataload=False):
        ...
        # Telescope
        self.name = 'VLT'
        self.tel = dict(area = 48.5, # effective aperture in squared meter, 51.3 according to Matteo G.
                        diameter = 8.20, # prirmary diameter in meter
                        )      
        # IFS
        self.ifs = {} 
        ...
        self.giraffe[chan] = dict(desc='Based on ESO ETC 17/01/2023',
                                  ...
                                  iq_beta = 999, # beta PSF of telescope + instrument                            
                                  ...
                                  dcurrent = 0.503, # dark current (e-/pixel/h)                                
                                ) 
        if not skip_dataload:
